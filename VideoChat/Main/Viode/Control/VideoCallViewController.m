...
{
    NSString *storyName = @"VideoCallViewController";
    self = [[UIStoryboard storyboardWithName:@"Video" bundle:nil] instantiateViewControllerWithIdentifier:storyName];
    if (self) {
...
{
    [self _stopRing];
//    [[VIdeoChatViewController sharedManager] answerCall:self.callSession.callId];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"videoAnswer" object:nil];
}
...
//    [[VIdeoChatViewController sharedManager] hangupCallWithReason:EMCallEndReasonDecline];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"videoReject" object:nil];
}
...
//    [[VIdeoChatViewController sharedManager] hangupCallWithReason:EMCallEndReasonHangup];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"videoHangup" object:nil];
}
